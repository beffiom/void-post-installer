...
sleep 3s
	sudo xbps-install -Sy xorg-minimal xf86-input-libinput xf86-input-synaptics xf86-video-fbdev xautolock xbacklight xclip xclipboard xinit xmodmap xscreensaver xwallpaper libva make gcc base-devel libX11-devel libXrandr-devel libXft-devel libXinerama-devel pkg-config
	sudo xbps-install -Sy xf86-video-intel libva-intel-driver linux-firmware-intel
	...
	sudo xbps-install -Sy python3 python3-devel python3-pip python3-pyperclip
...
sleep 3s
	...
	sudo ln -sf /etc/sv/upower /var/service/
